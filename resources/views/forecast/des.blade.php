...
@section('title', 'Peramalan - Double Exponential Smoothing')
    ...
    <div class="card">
        <div class="card-header">
            <div class="d-flex justify-content-between align-items-center">
                <h5 class="mb-0">Double Exponential Smoothing (DES)</h5>
        ...
        <div class="card-body">
            ...
            <form action="{{ route('forecast.calculate') }}" method="POST">
                @csrf
                <input type="hidden" name="method" value="des">
                ...
                <div class="alert alert-info">
                    <h6><i class="fas fa-info-circle me-2"></i> Tentang Double Exponential Smoothing</h6>
                    <p class="mb-0">Metode ini cocok untuk data dengan tren naik atau turun. Parameter alpha (α) mengontrol penghalusan level, sedangkan beta (β) mengontrol penghalusan tren. Nilai yang lebih tinggi memberikan bobot lebih pada data terbaru.</p>
                </div>
